...
if not os.path.isfile("Intermediate/files/my_file.txt"):
  txt_file = open(file="Intermediate/files/my_file.txt", mode="w+") # Escribir y mas
  txt_file.write("Mi nombre es Diego\nMi apellido es Chiapa\nTengo 32 años\nY mi lenguaje preferido es Python")
  txt_file.close()
  print("Se ha creado el archivo: my_file.txt")

txt_file = open(file="Intermediate/files/my_file.txt", mode="r+") # Leer y Escribir
# print(txt_file.read())
...
'''
with open("Intermediate/files/my_file.json") as my_other_file:
...
csv_file = open("Intermediate/files/my_file.csv", "w+", newline='')
...
csv_file = open("Intermediate/files/my_file.csv", "r+")
with open("Intermediate/files/my_file.csv") as my_other_file:
